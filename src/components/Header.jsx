...
const Header = () => {
  return (
    ...
    <header className="flex flex-row flex-wrap items-center justify-between py-1 px-6  bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-500">
      ...
      <h2 className="text-2xl text-center md:text-3xl text-gray-300 font-inter font-extrabold"><span style={{"font-family": 'Special Elite',}}>Mogojastro</span> Registration Form </h2>
